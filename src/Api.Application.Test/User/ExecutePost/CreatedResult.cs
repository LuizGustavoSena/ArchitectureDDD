...
namespace Api.Application.Test.User.ExecutePost
{
    public class CreatedResult
    {
        ...
        public async Task SucessPost()
        {
            ...
            Assert.True(result is Microsoft.AspNetCore.Mvc.CreatedResult);

            var resultValue = ((Microsoft.AspNetCore.Mvc.CreatedResult)result).Value as UserDtoCreateResult;
